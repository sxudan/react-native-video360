...
function Home() {
  ...
  return (
    <View style={{ flex: 1}}>
      <Video360Player style={{flex: 1}} urlVideo={'https://agriknow-development-assets.s3.ap-southeast-2.amazonaws.com/2041337d-08ed-4f9b-ae4a-dc6046e70abe.mp4'} modeVideo={mode}/>
